...
from game_ac_network import GameACFFNetwork, GameACLSTMNetwork, ConvGameACLSTMNetwork, DenseGameACLSTMNetwork
...
def main(GameState, Network):
    ...
    global_network = Network(
        GameState.ACTION_SIZE, -1, GameState.environment_shape, device
    )
    ...
    def train_function(parallel_index):
        ...
        while True:
            ...
            diff_global_t = training_thread.process(
                sess, global_t, summary_writer, summary_op, score_input
            )
...
if __name__ == '__main__':
    ...
    # from alt_game_state import GameState
    # Network = ConvGameACLSTMNetwork

    from game_state_arm import VirtualArmGameState as GameState
    Network = DenseGameACLSTMNetwork

    main(GameState, Network)
